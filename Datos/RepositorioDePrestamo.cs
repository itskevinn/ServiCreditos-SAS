...
values (@Id, @Nombre, @CapitalInicial, @TasaInteres, @Tiempo, @CapitalFinal)";
        ...
        private Prestamo MapearDatosEnLector (SqlDataReader lectorDeDatos) {
            ...
            prestamo.IdentificacionPaciente = (string) lectorDeDatos["Id"];
            prestamo.IdentificacionPaciente = (string) lectorDeDatos["Nombre"];
            prestamo.ValorServicio = (decimal) lectorDeDatos["CapIni"];
            prestamo.ValorServicio = (decimal) lectorDeDatos["TasaInt"];
            prestamo.CapitalInicial = (decimal) lectorDeDatos["Tiempo"];                     
            prestamo.CapitalInicial = (decimal) lectorDeDatos["CapFin"];
            return prestamo;
        }
    }
}